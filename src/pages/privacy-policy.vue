...
<template>
  <div class="content w-limited">
    ...
    <ul>
      ...
      <li>
        <p><strong>Application</strong> refers to D9 Network, the software program provided by the Company.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to D9 Network LLC, 611 South DuPont Highway Suite 102 Dover, DE 19901.</p>
...
.content {
  text-wrap: balance;
  h1 {
    @apply text-3xl font-bold my-6 mt-14 border-b-4 border-b-white/40 pb-2;
  }
  h2 {
    @apply text-2xl font-bold my-4 mt-10 border-b-2 border-b-white/30 pb-1;
  }
  h3 {
    @apply text-xl font-bold my-2 mt-6;
  }
  h4 {
    @apply text-lg font-bold my-1 mt-4;
  }
  p {
    @apply my-2;
    /* text-indent: 1em; */
